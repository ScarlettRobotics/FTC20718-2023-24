 ...
 */
@Config
public class ScarlettDriveConstants {
    ...
    public static double MAX_ANG_VEL = Math.toRadians(346.8); // Maximum velocity the robot can turn at
    public static double MAX_ANG_ACCEL = Math.toRadians(346.8);
